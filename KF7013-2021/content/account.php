	...
	<main id="content"> <!-- Beginning of page content -->
		<?php 
			...
			if (isset($_GET['delete_id'])) {
				...
				booked_act_details(true);
				echo '<form id="confirmed" method="post" action="/w19041690/kf7013-2021/content/php/dodelete.php?delete_id='.$_GET['delete_id'].'"><button type="submit" class="tworem">Confirm</button></form>';
			}
			booked_act();
