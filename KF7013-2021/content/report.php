...
<body class="<?php classID() ?>">
	...
	<main id="content"> <!-- Beginning of page content -->
		<div id="essay">
			...
			<aside>Word Count excluding citations: 989</aside>
			<h2>References</h2> 
			<ul>
